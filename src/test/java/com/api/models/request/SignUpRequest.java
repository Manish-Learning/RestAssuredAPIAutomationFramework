...
public class SignUpRequest {
	...
	// Not going to have Constructor inside the Builder class only methods
	...
	public static class Builder {
		...
		/*
		 * public Builder userName(String username) { this.username=username; Builder
		 * builder = new Builder(); return builder; }
		 */
